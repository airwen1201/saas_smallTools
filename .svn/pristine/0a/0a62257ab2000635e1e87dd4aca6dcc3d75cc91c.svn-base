 ...
 */
//账户详情列表
Tailorpus.controller('AccountDetailListCtrl', function($scope,$state,$stateParams,DataService) {
    //用户信息
    ...
    //获取应收列表
    var getPayableDetailList = function(vipId1,vipId2) {
        var promise = DataService.getPayableDetailList(vipId1,vipId2);
    ...
    getPayableDetailList(obj.vipId,vip2);
    console.log(obj.vipId,vip2)
});
